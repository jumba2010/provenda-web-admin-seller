...
const { Step } = Steps;
const { Option } = Select;
import {findUnitiesBySucursal,findCategoriesBySucursal,findProductById,findTaxesBySucursal,addTax,addProduct} from '../service';
...
const UpdateForm = props => {
  ...
  useEffect(() => {
    findUnitiesBySucursal().then(function (result){
     ...
     findProductById(id).then(function (result){
      setCategory(result.category.description) 
     });
